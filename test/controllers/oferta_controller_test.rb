...
class OfertaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ofertum" do
    assert_difference("Ofertum.count") do
      post oferta_url, params: { ofertum: { description: @ofertum.description, salario: @ofertum.salario, titulo: @ofertum.titulo } }
    end
  ...
  test "should update ofertum" do
    patch ofertum_url(@ofertum), params: { ofertum: { description: @ofertum.description, salario: @ofertum.salario, titulo: @ofertum.titulo } }
